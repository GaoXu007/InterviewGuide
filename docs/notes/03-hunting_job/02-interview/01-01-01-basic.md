...
- 分配失败时，malloc返回空指针NULL，new会抛出bad_alloc异常；
（[free](https://zh.cppreference.com/w/cpp/memory/c/free)和delete无返回值，注意与[malloc](https://zh.cppreference.com/w/cpp/memory/c/malloc)和new的区别！）
